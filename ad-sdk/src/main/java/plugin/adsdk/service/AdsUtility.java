...
//                                interstitialAd = null;
    ...
    private static void logBanner(BaseActivity activity, String source) {
        Bundle params = new Bundle();
    ...
    public static void log(Context context, String eventName) {
        Bundle params = new Bundle();
        FirebaseAnalytics.getInstance(context).logEvent("eht_" + eventName, params);
    }
}