...
import static com.cashloan.myapplication.videoplayer.other.CommonClass.convertMillisToTime;
import static com.cashloan.myapplication.videoplayer.other.CommonClass.getFormattedDuration;
...
public class VideoAdapter extends RecyclerView.Adapter<VideoAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull VideoAdapter.ViewHolder holder, int position) {
        ...
        String Duration = millisecToTime((int) videoItem.getDuration_milis());
        String Date = convertMillisToTime(new File(videoItem.getVideopath()).lastModified(), "dd/MM/yyyy");
        String VideoName = videoItem.getVideodisplayname();
        String VideoPath = videoItem.getVideopath();
        String VideoSize = videoItem.getVideosize();
            ...
            public void onClick(View v) {
                ...
                play.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(activity, VideoPlayerActivity.class);
                        intent.putExtra("video", new Gson().toJson(videoItems));
                        intent.putExtra("position", position);
                        activity.startActivity(intent);
                        dialog.dismiss();
                    }
                                ...
                                if (editText.getText().toString().isEmpty()) {
                                    ...
                                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
                                        ...
                                        if (rename) {
                                            ...
                                            Toast.makeText(activity, "Oops! rename failed", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                    rename_dialog.dismiss();
                                }
                ...
                delete.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        delete_btn.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                deleteData.deleteclick(new File(VideoPath), 0);
                                delete_dialog.dismiss();
                            }
                        });
