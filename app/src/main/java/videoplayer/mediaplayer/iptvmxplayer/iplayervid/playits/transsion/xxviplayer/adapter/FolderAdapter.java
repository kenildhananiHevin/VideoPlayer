...
public class FolderAdapter extends RecyclerView.Adapter<FolderAdapter.ViewHolder> {
    ...
    public FolderAdapter(BaseActivity requireActivity, List<VideoFolderSize> folderItem,String list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (list.equals("LinearLayoutManager")){
            ...
            return new ViewHolder(LayoutInflater.from(requireActivity).inflate(R.layout.folder_grid_item, parent, false));
        }
    ...
    public void onBindViewHolder(@NonNull FolderAdapter.ViewHolder holder, int position) {
        ...
        holder.folder_size.setSelected(true);
